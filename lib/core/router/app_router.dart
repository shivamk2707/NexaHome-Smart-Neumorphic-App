...
class AppRouter {
  static final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/ac_control/:id', builder: (context, state) => AcControlScreen(deviceId: state.pathParameters['id'] ?? 'd1')),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/fan_control/:id', builder: (context, state) => FanControlScreen(deviceId: state.pathParameters['id'] ?? 'd4')),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/light_control/:id', builder: (context, state) => SmartLightControlScreen(deviceId: state.pathParameters['id'] ?? 'd2')),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/lock_control/:id', builder: (context, state) => SmartLockScreen(deviceId: state.pathParameters['id'] ?? 'd3')),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/security_camera', builder: (context, state) => const SecurityCameraScreen()),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/add_device', builder: (context, state) => const AddNewDeviceScreen()),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/device_pairing', builder: (context, state) => const DevicePairingScreen()),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/device_setup_form', builder: (context, state) => const DeviceSetupFormScreen()),

      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/room_details/:id', builder: (context, state) => RoomDetailsScreen(roomId: state.pathParameters['id'] ?? 'r1')),
      ...
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/settings', builder: (context, state) => const SettingsScreen()),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/activity_history', builder: (context, state) => const ActivityHistoryScreen()),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/help_support', builder: (context, state) => const HelpSupportScreen()),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/home_members', builder: (context, state) => const HomeMembersScreen()),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/notifications', builder: (context, state) => const NotificationsScreen()),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/security_settings', builder: (context, state) => const SecuritySettingsScreen()),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/subscription_plan', builder: (context, state) => const SubscriptionPlanScreen()),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/favorites', builder: (context, state) => const FavoritesScreen()),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/voice_control', builder: (context, state) => const VoiceControlScreen()),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/ai_smart_assistant', builder: (context, state) => const AiSmartAssistantScreen()),

      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/empty_state_devices', builder: (context, state) => const EmptyStateDevicesScreen()),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/error_state_connection', builder: (context, state) => const ErrorStateConnectionScreen()),
      GoRoute(parentNavigatorKey: _rootNavigatorKey, path: '/success_state_device_connected', builder: (context, state) => const SuccessStateDeviceConnectedScreen()),
    ],
  );
}
