...
class CreateAutomationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('New Routine', style: AppTextStyles.headlineMedium(Theme.of(context).colorScheme.onSurface)),
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text('Routine Name', style: AppTextStyles.labelSmall(AppColors.lightTextSecondary)),
              SizedBox(height: 8.h),
              NeumorphicContainer(
                isPressed: true,
                borderRadius: 16.r,
              ...
              NeumorphicButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 8.w),
                    Text('Add Trigger', style: AppTextStyles.labelMedium(AppColors.primary)),
                  ],
                ),
              ),
              ...
              SizedBox(
                ...
                child: NeumorphicButton(
                  ...
                  borderRadius: 16.r,
                  child: Center(
                    child: Text('Save Routine', style: AppTextStyles.labelMedium(AppColors.primary)),
                  ),
                ),
              ),
            ],
