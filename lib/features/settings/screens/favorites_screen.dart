  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Favorites', style: AppTextStyles.headlineMedium(Theme.of(context).colorScheme.onSurface)),
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text('Quick Access Devices', style: AppTextStyles.headlineMedium(Theme.of(context).colorScheme.onSurface)),
              ...
              GridView.count(
                ...
                children: [
                  ...
                  _buildDeviceCard(context, 'Front Door', Icons.lock, true),
                ],
              ),
            ],
          ),
