...
class OnboardingAutomationScreen extends StatelessWidget {
  const OnboardingAutomationScreen({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Set schedules and triggers so your home works for you.',
